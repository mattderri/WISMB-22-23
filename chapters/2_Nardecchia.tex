...
\begin{equation}
\labeq{t1}
U\to LUR^\dagger \qquad U^\dagger\to RU^\dagger L^\dagger
\end{equation}
...
\left\{
\begin{aligned}
&U\to LUR^\dagger=\left(1-i\theta_a^L\frac{\lambda_a}{2}\right)U &&U^\dagger\to RU^\dagger L^\dagger=\left(1+i\theta_a^L\frac{\lambda_a}{2}\right)U^\dagger\\
&\partial_\mu U\to\left(1-i\theta_a^L\frac{\lambda_a}{2}\right)\partial_\mu U-i\frac{\lambda_a}{2}\partial_\mu\theta_a^LU && \partial^\mu U^\dagger\to\partial^\mu U^\dagger\left(1+i\theta_a^L\frac{\lambda_a}{2}\right)+iU^\dagger\frac{\lambda_a}{2}\partial^\mu\theta^L_a
\end{aligned}
\right.
\]
From this, we obtain:
\[
\begin{aligned}
\delta\pazocal{L}&=\frac{f^2}{4}\Tr{i(\partial_\mu U)U^\dagger\frac{\lambda_a}{2}\partial^\mu\theta_a^L-i\frac{\lambda_a}{2}\partial_\mu\theta_a^LU(\partial^\mu U^\dagger)}\\
&=\frac{f^2}{4}i\partial_\mu\theta_a^L\Tr{\frac{\lambda_a}{2}[(\partial^\mu U)U^\dagger-U(\partial^\mu U^\dagger)]}\\
&=\frac{f^2}{4}i\partial_\mu\theta_a^L\Tr{\lambda_a(\partial^\mu U)U^\dagger}
...
\begin{equation}
\labeq{jl}
J_L^{\mu,a}=\frac{\partial\delta\pazocal{L}}{\partial\partial_\mu\theta_a^L}=i\frac{f^2}{4}\Tr{\lambda_a(\partial^\mu U)U^\dagger}
\end{equation}
In the same way, by setting $\theta_a^L=0$, for the right currents one gets:
\begin{equation}
\labeq{jr}
J_R^{\mu,a}=\frac{\partial\delta\pazocal{L}}{\partial\partial_\mu\theta_a^R}=-i\frac{f^2}{4}\Tr{\lambda_aU^\dagger(\partial^\mu U)}
\end{equation}
...
K^+\to\pi^0e^+\nu_e \quad K^0\to\pi^-e^+\nu_e
\]
% The two decays have different charges, the $K^0$ decay has a spectator $\overline{d}$ quark while the $K^+$ decay has a spectator $\overline{u}$ quark.
